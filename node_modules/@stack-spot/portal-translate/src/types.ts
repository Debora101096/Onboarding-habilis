/* ISO 639-1 */
export type Language = 'aa' | 'ab' | 'ae' | 'af' | 'ak' | 'am' | 'an' | 'ar' | 'as' | 'av' | 'ay' | 'az' | 'ba' | 'be' | 'bg' | 'bh' | 'bi'|
  ...
  'qu' | 'rm' | 'rn' | 'ro' | 'ru' | 'rw' | 'sa' | 'sc' | 'sd' | 'se' | 'sg' | 'si' | 'sk' | 'sl' | 'sm' | 'sn' | 'so' | 'sq' | 'sr' |
...
export type OnChange = (language: Language) => void
export type OnChangeConfig = (config: Required<TranslationConfig>) => void
export type Dictionary<L extends Language = 'pt' | 'en'> = Record<L, Record<string, string>>
export type ESDict = Dictionary<'pt' | 'en' | 'es'>
