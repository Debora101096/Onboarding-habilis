 ...
 */
export const Dialog = ({ children, title, subtitle, cancel, confirm, validation, onGoBack, onConfirm, onCancel, type = 'modal', buttonPlacement = type === 'panel' ? 'left' : 'right', buttonColor = 'primary', }) => {
