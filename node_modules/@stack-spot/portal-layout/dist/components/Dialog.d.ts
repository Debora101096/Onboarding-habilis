 ...
 */
export declare const Dialog: ({ children, title, subtitle, cancel, confirm, validation, onGoBack, onConfirm, onCancel, type, buttonPlacement, buttonColor, }: Props) => import("react/jsx-runtime").JSX.Element;
export {};
