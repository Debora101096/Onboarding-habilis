...
type APIName = 'account' | 'content' | 'workspace' | 'runtime-manager' | 'workspace-manager' | 'search-engine' | 'hub' | 'code-buddy' | 'plugin' | 'catalog' | 'insights' | 'cloud-services' | 'cloud-account' | 'secrets' | 'agents' | 'shared-control' | 'cloud-platform-horizon' | 'workspace-ai' | 'code-shift' | 'agent-tools' | 'ai-inference' | 'data-integration';
...
export { CompletablePromise, requestPermission, setup };
export type { APIMap };
