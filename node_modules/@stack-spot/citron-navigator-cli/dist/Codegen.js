...
class Codegen {
    constructor({ root, isModule }, useHash = true) {
        ...
        Object.defineProperty(this, "keyToClassName", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "isModule", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    writeRootAndNavigatorConstants() {
    ...
    async format(code, baseDir) {
        const { error, message } = await (0, typescript_formatter_1.processString)('navigation.ts', code, {
            baseDir,
            replace: false,
            editorconfig: true,
            tsconfig: false,
    ...
    async writeToFile(path, baseDir) {
        if (!this.code.length)
            this.write();
        const code = this.code.join('\n');
        const formatted = await this.format(code, baseDir);
        try {
            await (0, promises_1.mkdir)((0, path_1.dirname)(path));
        }
        catch { /* empty */ }
        await (0, promises_1.writeFile)(path, formatted, { encoding: 'utf-8' });
    }
}
