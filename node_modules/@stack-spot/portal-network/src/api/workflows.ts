 ...
 */
export function v3DispatchWorkflowExecutionServiceV3WorkflowsDispatchPost({ authorization, stackspotCustomerIp, xAccountId, xAccountSlug, srcPresentationApiRestServicesWorkflowsV3RequestsDispatchWorkflowExecutionRequestDispatchWorkflowExecutionRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
    ...
    return oazapfts.ok(oazapfts.fetchJson<{
        ...
        status: 503;
        data: HttpErrorResponse;
    }>("/v3/workflows/dispatch", oazapfts.json({
        ...opts,
        method: "POST",
        body: srcPresentationApiRestServicesWorkflowsV3RequestsDispatchWorkflowExecutionRequestDispatchWorkflowExecutionRequest,
        headers: oazapfts.mergeHeaders(opts?.headers, {
            authorization,
            "stackspot-customer-ip": stackspotCustomerIp,
