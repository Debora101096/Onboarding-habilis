...
export interface QueryObject<Variables, Result> extends OperationObject<Variables> {
     ...
     * - [3]: the original UseQueryResult object, from ReactQuery.
     */
    useStatefulQuery: (...args: Variables extends void ? [options?: UseQueryObjectOptions<Result>] : [variables: Variables, options?: UseQueryObjectOptions<Result>]) => Readonly<[Result | undefined, boolean, StackspotAPIError | null | undefined, UseQueryResult<Result, StackspotAPIError>]>;
    /**
...
export interface InfiniteQueryObject<Variables, Result, Accumulator extends keyof Result | ''> extends QueryObject<Variables, Result> {
     ...
     */
    useInfiniteQuery: (...args: Partial<Variables> extends Variables ? [variables?: Variables, options?: UseInfiniteQueryObjectOptions<Result>] : [variables: Variables, options?: UseInfiniteQueryObjectOptions<Result>]) => Readonly<[
     ...
     */
    useStatefulInfiniteQuery: (...args: Partial<Variables> extends Variables ? [variables?: Variables, options?: UseInfiniteQueryObjectOptions<Result>] : [variables: Variables, options?: UseInfiniteQueryObjectOptions<Result>]) => Readonly<[
...
export type OperationResult<T extends {
    ...
    query: (variables?: any) => Promise<infer R>;
} ? R : (T extends {
    mutate: (variables?: any) => Promise<infer R>;
} ? R : never);
