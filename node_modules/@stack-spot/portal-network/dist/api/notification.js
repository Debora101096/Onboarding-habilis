 ...
 */
export function create({ dryRun, tenantId, createTenantNotificationRequest }, opts) {
 ...
 */
export function findAll({ size, page, createdSince, context, criticality, content, committed, isBanner, audience, tenantId }, opts) {
 ...
 */
export function committedNotifications({ audience, tenantId }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/v1/tenants/${encodeURIComponent(tenantId)}/notifications/committed${QS.query(QS.explode({
        audience
    }))}`, {
        ...opts
    }));
 ...
 */
export function deleteV1TenantsByTenantIdNotificationsAndNotificationIntentId({ notificationIntentId, tenantId }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/v1/tenants/${encodeURIComponent(tenantId)}/notifications/${encodeURIComponent(notificationIntentId)}`, {
        ...opts,
        method: "DELETE"
    }));
}
 ...
 */
export function delete1({ notificationIntentId }, opts) {
