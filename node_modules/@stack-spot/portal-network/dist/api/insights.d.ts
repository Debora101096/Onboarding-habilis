 ...
 */
export declare function downloadStudioData({ accountSlug, studioSlug, startDate, endDate, dataset, stackspotCustomerIp }: {
    accountSlug: string;
    studioSlug: string;
    startDate: string;
    endDate: string;
 ...
 */
export declare function downloadAccountData({ accountSlug, startDate, endDate, dataset, stackspotCustomerIp }: {
    accountSlug: string;
    startDate: string;
    endDate: string;
    dataset: string;
 ...
 */
export declare function getDashboardAccount({ accountSlug, startDate, endDate, panels, page, size, stackspotCustomerIp }: {
    accountSlug: string;
    startDate?: string;
    endDate?: string;
    panels?: string[];
