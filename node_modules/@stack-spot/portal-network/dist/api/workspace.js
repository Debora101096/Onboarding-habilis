 ...
 */
export function accountSharedInfrastructureControllergetStackVersionsInUse(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/v1/shared-infra/stacks/versions", {
        ...opts
    }));
}
/**
 ...
 * Get stack version in use by applications in account
 */
export function accountApplicationControllergetStackVersionsInUse(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/v1/applications/stacks/versions", {
        ...opts
    }));
}
/**
