...
export type WorkflowType = "starter" | "create" | "deploy" | "rollback" | "destroy" | "reusable" | "extension";
...
export type StackRequest = {
    ...
    workflowStudioFromStack?: string | null;
};
...
export type StackResponse = {
    stack_version_id: string | null;
    stack_slug: string | null;
    workflow_studio_from_stack: string | null;
};
...
export type TargetRequestBase = {
    id: string;
    "type": TargetType;
    name?: string | null;
    description?: string | null;
};
export type EnvRequestBase = {
    id: string;
    slug: string;
};
export type WorkflowRequest2 = {
    ...
    targets?: TargetRequestBase[];
    env?: EnvRequestBase | null;
    base_workflow_type?: WorkflowType | null;
};
export type DispatchWorkflowExecutionRequest2 = {
    ...
    ignoreInputsInjection?: string[] | null;
    allowRetry?: boolean | null;
};
export type WorkflowRequest3 = {
    name: string;
    label: string;
    "type": WorkflowType;
    inputs: {
...
export type DispatchWorkflowExecutionRequest3 = {
    injectScmIntegration?: boolean;
    workspace?: WorkspaceRequest | null;
    workflow: WorkflowRequest3;
    frontData?: {
        [key: string]: any;
    } | null;
 ...
 * Run Action Service
 */
export declare function runActionServiceWorkflowsRunActionDispatchPost({ authorization, stackspotCustomerIp, xExecutionId, runActionRequest }: {
 ...
 * Create App Service
 */
export declare function createAppServiceWorkflowsCreateAppDispatchPost({ authorization, stackspotCustomerIp, xExecutionId, createAppRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
    xExecutionId?: string | null;
 ...
 * Create Api Service
 */
export declare function createApiServiceWorkflowsCreateApiDispatchPost({ authorization, stackspotCustomerIp, xExecutionId, createApiRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
    xExecutionId?: string | null;
 ...
 */
export declare function createInfraServiceWorkflowsCreateInfraDispatchPost({ authorization, stackspotCustomerIp, xExecutionId, createInfraRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
    xExecutionId?: string | null;
 ...
 */
export declare function applyPluginServiceWorkflowsApplyPluginDispatchPost({ authorization, stackspotCustomerIp, xExecutionId, applyPluginRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
    xExecutionId?: string | null;
 ...
 */
export declare function healthCheckServiceWorkflowsHealthCheckDispatchPost({ authorization, stackspotCustomerIp, xExecutionId, body }: {
    authorization: string;
    stackspotCustomerIp?: string;
    xExecutionId?: string | null;
 ...
 * Step Report Service
 */
export declare function stepReportServiceExecutionsExecutionIdWorkflowsStepsReportPost({ executionId, authorization, stepReportRequest }: {
    executionId: string;
    authorization: string;
 ...
 */
export declare function getExecutionDispatchRequestServiceWorkflowsExecutionIdRequestGet({ executionId, authorization }: {
    executionId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<any>;
/**
 ...
 */
export declare function getExecutionStatusServiceWorkflowsExecutionStatusExecutionIdGet({ executionId, authorization }: {
    executionId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<ExecutionResponse>;
/**
 * Create Semaphore Service
 */
export declare function createSemaphoreServiceSemaphoresPost({ authorization }: {
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<CreateSemaphoreResponse>;
/**
 * Get Semaphore Service
 */
export declare function getSemaphoreServiceSemaphoresSemaphoreIdGet({ semaphoreId, authorization }: {
    semaphoreId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<GetSemaphoreResponse>;
/**
 * Update Semaphore Service
 */
export declare function updateSemaphoreServiceSemaphoresSemaphoreIdPut({ semaphoreId, authorization, updateSemaphoreRequest }: {
    semaphoreId: string;
    authorization: string;
 ...
 */
export declare function v1CreateWorkflowExecutionServiceV1ExecutionsPost({ authorization, stackspotCustomerIp, createWorkflowExecutionRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
 ...
 */
export declare function v1PutWorkflowExecutionWorkflowServiceV1ExecutionsExecutionIdWorkflowsPut({ executionId, authorization, createWorkflowExecutionWorkflowRequest }: {
    executionId: string;
    authorization: string;
 ...
 */
export declare function v1ReportWorkflowStepServiceV1ExecutionsExecutionIdStepsPut({ executionId, authorization, putWorkflowExecutionWorkflowStepRequest }: {
    executionId: string;
    authorization: string;
    putWorkflowExecutionWorkflowStepRequest: PutWorkflowExecutionWorkflowStepRequest;
}, opts?: Oazapfts.RequestOpts): Promise<WorkflowExecutionResponse>;
/**
 * V1 Report Workflow Step Log Service
 */
export declare function v1ReportWorkflowStepLogServiceV1ExecutionsExecutionIdStepsLogsPut({ executionId, authorization, putWorkflowExecutionWorkflowStepLogRequest }: {
    executionId: string;
    authorization: string;
 ...
 */
export declare function v1GetWorkflowExecutionJobGraphServiceV1ExecutionsExecutionIdGet({ executionId, authorization }: {
    executionId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<GetWorkflowExecutionJobGraphResponse>;
/**
 * V1 Get Workflow Execution Job Detail Service
 */
export declare function v1GetWorkflowExecutionJobDetailServiceV1ExecutionsExecutionIdJobsJobIdGet({ executionId, jobId, authorization }: {
    executionId: string;
    jobId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<WorkflowJobDetailResponse>;
/**
 * V1 Accept Workflow Execution Job Suspended Service
 */
export declare function v1AcceptWorkflowExecutionJobSuspendedServiceV1ExecutionsExecutionIdJobsJobIdAcceptPost({ executionId, jobId, authorization, stackspotCustomerIp }: {
    executionId: string;
    jobId: string;
    authorization: string;
    stackspotCustomerIp?: string;
 ...
 */
export declare function v1RefuseWorkflowExecutionJobSuspendedServiceV1ExecutionsExecutionIdJobsJobIdRefusePost({ executionId, jobId, authorization, stackspotCustomerIp }: {
    executionId: string;
    jobId: string;
    authorization: string;
    stackspotCustomerIp?: string;
 ...
 */
export declare function v1GetWorkflowExecutionCliStateServiceV1ExecutionsExecutionIdStateGet({ executionId, authorization }: {
    executionId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<GetWorkflowExecutionCliStateResponse>;
/**
 * V1 Dispatch Workflow Execution Service
 */
export declare function v1DispatchWorkflowExecutionServiceV1WorkflowsDispatchPost({ authorization, stackspotCustomerIp, srcPresentationApiRestServicesWorkflowsV1RequestsDispatchWorkflowExecutionRequestDispatchWorkflowExecutionRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
 ...
 */
export declare function v1PostWorkflowExecutionFailureServiceV1ExecutionsExecutionIdFailurePost({ executionId, authorization, postWorkflowExecutionFailureRequest }: {
    executionId: string;
    authorization: string;
 ...
 */
export declare function v1PostWorkflowExecutionSignalServiceV1AccountsAccountSlugExecutionsExecutionIdSignalSignalPost({ executionId, signal, accountSlug }: {
    executionId: string;
 ...
 */
export declare function v1PutWorkflowExecutionSummaryServiceV1ExecutionsExecutionIdSummaryPut({ executionId, authorization, putWorkflowExecutionSummaryRequest }: {
    executionId: string;
    authorization: string;
 ...
 */
export declare function v1PutWorkflowScmExecutionIdV1ExecutionsExecutionIdBindScmPut({ executionId, authorization, putWorkflowScmExecutionRequest }: {
    executionId: string;
    authorization: string;
 ...
 */
export declare function v1RetryWorkflowExecutionV1ExecutionsExecutionIdRetryPost({ executionId, authorization, stackspotCustomerIp, postRetryWorkflowExecutionRequest }: {
    executionId: string;
    authorization: string;
    stackspotCustomerIp?: string;
 ...
 */
export declare function v1GetWorkflowExecutionAttemptsV1ExecutionsExecutionIdAttemptsGet({ executionId, authorization }: {
    executionId: string;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<WorkflowExecutionAttemptsResponse[]>;
/**
 * V2 Dispatch Workflow Execution Service
 */
export declare function v2DispatchWorkflowExecutionServiceV2WorkflowsDispatchPost({ authorization, xUserAuthorization, stackspotCustomerIp, srcPresentationApiRestServicesWorkflowsV2RequestsDispatchWorkflowExecutionRequestDispatchWorkflowExecutionRequest }: {
    authorization: string;
...
/**
 * V3 Dispatch Workflow Execution Service
 */
export declare function v3DispatchWorkflowExecutionServiceV3WorkflowsDispatchPost({ authorization, stackspotCustomerIp, xAccountId, xAccountSlug, srcPresentationApiRestServicesWorkflowsV3RequestsDispatchWorkflowExecutionRequestDispatchWorkflowExecutionRequest }: {
    authorization: string;
    stackspotCustomerIp?: string;
    xAccountId?: string | null;
    xAccountSlug?: string | null;
    srcPresentationApiRestServicesWorkflowsV3RequestsDispatchWorkflowExecutionRequestDispatchWorkflowExecutionRequest: DispatchWorkflowExecutionRequest3;
}, opts?: Oazapfts.RequestOpts): Promise<WorkflowExecutionResponse>;
