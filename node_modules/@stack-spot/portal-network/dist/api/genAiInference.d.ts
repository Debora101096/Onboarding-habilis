 ...
 * List Models
 */
export declare function listModelsV1LlmModelsGet({ active, resource, $default, displayName, selfHosted, orderBy, orderDir, page, pageSize, xAccountId, authorization }: {
    active?: boolean | null;
    ...
    xAccountId?: string | null;
    authorization: string;
}, opts?: Oazapfts.RequestOpts): Promise<PaginatedResponseLlmModelsResponse>;
/**
 * Get Model
 */
 ...
 * Get Models List
 */
export declare function getModelsListV1LlmModelsListPost({ xAccountId, authorization, getModelByIdsRequest }: {
    xAccountId?: string | null;
    authorization: string;
 ...
 */
export declare function createCompletionsV1ChatCompletionsPost({ xAccountId, authorization, xRequestOrigin, xConversationId, xMessageId, xQcExecutionId, xQcSlug, xPlatformVersion, chatCompletion }: {
    xAccountId?: string | null;
    authorization: string;
