 ...
 */
export function postV1AgentDependencies({ workspaceListRequest }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/v1/agent/dependencies", oazapfts.json({
        ...opts,
        method: "POST",
 ...
 */
export function getV1AgentKnowledgeSourceById({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/v1/agent/knowledge-source/${encodeURIComponent(id)}`, {
        ...opts
    }));
}
/**
 ...
 */
export function deleteV1AgentKnowledgeSourceById({ id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/v1/agent/knowledge-source/${encodeURIComponent(id)}`, {
        ...opts,
        method: "DELETE"
    }));
 ...
 */
export function postV1AgentWorkspaceFork({ workspaceForkRequest }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/v1/agent/workspace/fork", oazapfts.json({
        ...opts,
        method: "POST",
 ...
 */
export function deleteV1AgentWorkspaceFork({ workspaceDeleteRequest }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/v1/agent/workspace/fork", oazapfts.json({
        ...opts,
        method: "DELETE",
 ...
 * List Workspace Fork AI agents.
 */
export function postV1AgentWorkspaceList({ workspaceListRequest }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/v1/agent/workspace/list", oazapfts.json({
        ...opts,
        method: "POST",
        body: workspaceListRequest
    })));
 ...
 */
export function postV1AgentByAgentIdFavorite({ agentId }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/v1/agent/${encodeURIComponent(agentId)}/favorite`, {
        ...opts,
        method: "POST"
    }));
}
 ...
 */
export function deleteV1AgentByAgentIdFavorite({ agentId }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/v1/agent/${encodeURIComponent(agentId)}/favorite`, {
        ...opts,
        method: "DELETE"
    }));
 ...
 */
export function postV1AgentByAgentIdPublish({ agentId, publishRequest }, opts) {
 ...
 * AI Agent update visibility.
 */
export function postV1PublicAgentByAgentIdPublish({ agentId, publishRequest }, opts) {
