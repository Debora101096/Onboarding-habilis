...
class WorkspaceClient extends ReactQueryNetworkClient {
    constructor() {
        ...
        */
         ...
         */
        Object.defineProperty(this, "stacksVersionWithContext", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.mutation(contextControllerlistStackVersionsWithAccountContext)
        });
        /**
         *  import context of stack in workspace
         *  used to control permission
         */
        Object.defineProperty(this, "importStackContextInWorkspace", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.mutation(contextV2ControllerimportContextInWorkspace)
        });
        /**
         *  import context of stack in account
         *  used to control permission
         */
        Object.defineProperty(this, "importStackContextInAccount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.mutation(contextV2ControllerimportContextInAccount)
        });
    }
