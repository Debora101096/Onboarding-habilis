...
class CloudRuntimesClient extends ReactQueryNetworkClient {
    constructor() {
         ...
         */
        Object.defineProperty(this, "listLastApplicationDeploymentsByRuntime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.query(removeAuthorizationParam(getLastDeploymentByRuntime))
        });
        /**
         ...
         */
        Object.defineProperty(this, "startApplication", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.mutation(removeAuthorizationParam(startApplication))
        });
        /**
         * Stop an application
         */
        Object.defineProperty(this, "stopApplication", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.mutation(removeAuthorizationParam(stopApplication))
        });
        /**
         * Get secret keys of an application by runtime
         */
        Object.defineProperty(this, "applicationSecretKeys", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.query(removeAuthorizationParam(getSecrets))
        });
        /**
         * Get application instances in use
         */
        Object.defineProperty(this, "applicationInstancesNow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: this.query(removeAuthorizationParam(getInstances))
        });
        /**
         * Edit application instances
         */
        Object.defineProperty(this, "editApplicationInstances", {
            enumerable: true,
            configurable: true,
            writable: true,
...
//# sourceMappingURL=cloud-runtimes.js.map